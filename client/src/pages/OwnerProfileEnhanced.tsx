...
const OwnerProfileEnhanced = () => {
  ...
  const fetchOwnerData = async () => {
    ...
    try {
      ...
      // Populate settings form with owner data
      setSettingsForm({
        name: ownerData.name || '',
        ...
        socialLinks: {
          facebook: ownerData.socialLinks?.facebook || '',
          linkedin: ownerData.socialLinks?.linkedin || '',
          instagram: ownerData.socialLinks?.instagram || '',
          website: ownerData.socialLinks?.website || ''
        },
        notifications: {
          email: true,
          sms: false,
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      // In a real application, this would call an API to update the owner profile
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100">
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8 px-6" aria-label="Tabs">
            {['overview', 'equipment', 'reviews', 'settings', 'billing'].map((tab) => (
              <button
                key={tab}
        ...
        <div className="p-6">
          ...
          {/* Settings Tab */}
          {activeTab === 'settings' && user && user.id === owner.id && (
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm"
                >
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={settingsForm.address.country}
                        onChange={(e) => setSettingsForm({ 
                          ...settingsForm, 
                          address: { ...settingsForm.address, country: e.target.value }
                        })}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500"
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          ...
                          onChange={(e) => setSettingsForm({ 
                            ...settingsForm, 
                            notifications: { ...settingsForm.notifications, marketing: e.target.checked }
                          })}
                          className="sr-only peer"
                        />
                        <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    <button className="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 font-medium text-sm">
          ...
          {/* Billing Tab */}
          {activeTab === 'billing' && user && user.id === owner.id && (
            <div>
              <div className="flex items-center justify-between mb-6">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-r from-primary-50 to-primary-100 rounded-lg p-6 border border-primary-200">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="text-lg font-semibold text-primary-900">Professional Plan</h4>
                      <p className="text-primary-700 mt-1">Full access to all Sign World features</p>
                    </div>
                    <div className="text-right">
                      <p className="text-2xl font-bold text-primary-900">$49.99</p>
                      <p className="text-sm text-primary-600">per month</p>
                    </div>
                  </div>
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <p className="text-sm text-primary-600">Next billing date: February 15, 2024</p>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    {[
                      { date: '2024-01-15', amount: '$49.99', status: 'Paid', invoice: 'INV-2024-001' },
                      { date: '2023-12-15', amount: '$49.99', status: 'Paid', invoice: 'INV-2023-012' },
                      { date: '2023-11-15', amount: '$49.99', status: 'Paid', invoice: 'INV-2023-011' },
                      { date: '2023-10-15', amount: '$49.99', status: 'Paid', invoice: 'INV-2023-010' },
                    ].map((payment, index) => (
                ...
                {/* Usage & Limits */}
                <div className="bg-gray-50 rounded-lg p-6">
                  <h4 className="text-md font-semibold text-gray-900 mb-4">Usage & Limits</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white rounded-lg p-4 border border-gray-200">
                      <div className="text-center">
                        <p className="text-2xl font-bold text-primary-600">342</p>
                        ...
                        <p className="text-xs text-gray-400 mt-1">68% of 500 limit</p>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-gray-200">
                      <div className="text-center">
                        <p className="text-2xl font-bold text-green-600">15GB</p>
                        <p className="text-sm text-gray-500 mt-1">Storage used</p>
                        <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                          <div className="bg-green-600 h-2 rounded-full" style={{ width: '30%' }}></div>
                        </div>
                        <p className="text-xs text-gray-400 mt-1">30% of 50GB limit</p>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-gray-200">
                      <div className="text-center">
                        ...
                        <p className="text-xs text-gray-400 mt-1">56% of 50 limit</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <h4 className="text-md font-semibold text-gray-900 mb-4">Subscription Management</h4>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                    ...
                    <div className="flex space-x-3 pt-4 border-t border-gray-200">
                      <button className="inline-flex items-center px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 font-medium text-sm">
                        Change Plan
                      </button>
                      <button className="inline-flex items-center px-4 py-2 border border-red-300 text-red-700 rounded-lg hover:bg-red-50 font-medium text-sm">
                        Cancel Subscription
                      </button>
                    </div>
                  </div>
          ...
          {/* Access Denied Message for Settings/Billing */}
          {(activeTab === 'settings' || activeTab === 'billing') && (!user || user.id !== owner.id) && (
            <div className="text-center py-12">
              <ShieldCheckIcon className="h-12 w-12 text-gray-400 mx-auto mb-4" />
              <p className="text-gray-500">You can only view your own {activeTab} information.</p>
            </div>
          )}
        </div>
      </div>
